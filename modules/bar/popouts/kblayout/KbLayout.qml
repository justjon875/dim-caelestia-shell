...
ColumnLayout {
    ...
    StyledRect {
        ...
        implicitHeight: list.implicitHeight + Tokens.padding.normal * 2
        ...
        ListView {
            ...
            delegate: Item {
                ...
                width: list.width - Tokens.padding.normal * 2
    ...
    StyledRect {
        ...
        Layout.fillWidth: true
        implicitHeight: activeRow.implicitHeight + Tokens.padding.normal * 2
        radius: Tokens.rounding.normal
        color: Colours.tPalette.m3surfaceContainer
        clip: true
